...
### Subseccionar Dados de SP de 2019

munic_2019 <- subset(brasil_munic_2019, id %in% c(3550308))

###1 Seleção de Dados SP RENDA
renda_2019 <- data.frame(count(munic_2019, "FX_RENDA"))

renda_2019$FX_RENDA <- renda_2019$FX_RENDA[renda_2019$FX_RENDA==c(1, 2, 3, 4)]<-c("Até R$ 89,00", "Entre R$ 89,01 e R$ 178,00", "Até 1/2 Salário Mínimo", "Acima de 1/2 Salário Mínimo")

library(writexl)
library(xlsx)
write.xlsx(renda_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
           sheetName="Renda", append=TRUE)

###2 Seleção de Dados SP PBF
pbf_2019 <- data.frame(count(munic_2019 , "MARC_PBF"))

pbf_2019$MARC_PBF <- pbf_2019$MARC_PBF[pbf_2019$MARC_PBF==c(0, 1)]<-c("Sem Dados", "Sim")

write.xlsx(pbf_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
...
write.xlsx(fam_ind_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
...
quilom_2019$IN_FAMILIA_QUILOMBOLA_FAM <- quilom_2019$IN_FAMILIA_QUILOMBOLA_FAM[quilom_2019$IN_FAMILIA_QUILOMBOLA_FAM==c(1, 2)]<-c("Sim", "Não")

write.xlsx(quilom_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
...
mds_fam_2019$IN_PARC_MDS_FAM <- gsub(c("202"), c("Família de Pescadores Artesanais"), mds_fam_2019$IN_PARC_MDS_FAM)
...
write.xlsx(mds_fam_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
...
write.xlsx(ult_atua_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
...
esta_cadas_2019$CO_EST_CADASTRAL_MEMB <- esta_cadas_2019$CO_EST_CADASTRAL_MEMB [esta_cadas_2019$CO_EST_CADASTRAL_MEMB ==c(3, 4, 5)]<-c("Cadastrado", "Excluído", "Aguardando NIS")

write.xlsx(esta_cadas_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
...
write.xlsx(sexo_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
...
cor_2019$CO_RACA_COR_PESSOA <- cor_2019$CO_RACA_COR_PESSOA[cor_2019$CO_RACA_COR_PESSOA==c(1, 2, 3, 4, 5, "Sem Dados")]<-c("Branca", "Preta", "Amarela", "Parda", "Indígena", "Sem Dados")

write.xlsx(cor_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
           sheetName="Cor", append=TRUE)

###10 Seleção de Dados SP FX_ETARIA
idade_2019 <- data.frame(count(munic_2019 , "FX_ETARIA"))

idade_2019$FX_ETARIA <- idade_2019$FX_ETARIA[idade_2019$FX_ETARIA==c(1, 2, 3, 4, 5, 6)]<-c("Até 11 anos", "De 12 a 17 anos", "De 18 a 21 anos", "De 22 a 29 anos", "De 30 a 59 anos", "De 60 anos acima")

write.xlsx(idade_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
...
transtorno_2019$IN_DEF_TRANSTORNO_MENTAL_MEMB <- transtorno_2019$IN_DEF_TRANSTORNO_MENTAL_MEMB[transtorno_2019$IN_DEF_TRANSTORNO_MENTAL_MEMB ==c(1, "Sem Dados")]<-c("Sim", "Sem Dados")

write.xlsx(transtorno_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
...
ler_escrever_2019$CO_SABE_LER_ESCREVER_MEMB <- ler_escrever_2019$CO_SABE_LER_ESCREVER_MEMB [ler_escrever_2019$CO_SABE_LER_ESCREVER_MEMB ==c(1, 2, "Sem Dados")]<-c("Sim", "Não", "Sem Dados")

write.xlsx(ler_escrever_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
...
instrucao_2019$GRAU_INSTRUCAO <- instrucao_2019$GRAU_INSTRUCAO[instrucao_2019$GRAU_INSTRUCAO==c(0, 1, 2, 3, 4, 5, 6)]<-c("Sem Dados", "Sem Instrução", "Fundamental Incompleto", "Fundamental Completo", "Ensino Médio Incompleto", "Ensino Médio Completo", "Superior Incompleto ou Mais")

write.xlsx(instrucao_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
...
principal_trabalho_2019$CO_PRINCIPAL_TRAB_MEMB <- principal_trabalho_2019$CO_PRINCIPAL_TRAB_MEMB [principal_trabalho_2019$CO_PRINCIPAL_TRAB_MEMB ==c(1, 2, 3, 4, 5, 6, 7, 8, 10, 11, "Sem Dados")]<-c("Informal, Autônomo", "Trabalhador temporário em área rural", "Empregado sem carteira de trabalho assinada", "Empregado com carteira de trabalho assinada", "Trabalhador doméstico sem carteira de trabalho assinada", "Trabalhador doméstico com carteira de trabalho assinada", "Trabalhador Não-Remunerado" , "Militar ou servidor público", "Estagiário" , "Aprendiz", "Sem Dados")

write.xlsx(principal_trabalho_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
...
trabalho_12_meses_2019$CO_TRABALHO_12_MESES_MEMB <- trabalho_12_meses_2019$CO_TRABALHO_12_MESES_MEMB [trabalho_12_meses_2019$CO_TRABALHO_12_MESES_MEMB ==c(1, 2, "Sem Dados")]<-c("Sim", "Não", "Sem Dados")

write.xlsx(trabalho_12_meses_2019, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2019.xlsx",
