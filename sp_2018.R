...
### Subseccionar Dados de SP de 2018

munic_2018 <- subset(brasil_munic_2018, id %in% c(3550308))
...
library(writexl)
library(xlsx)
write.xlsx(renda_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
write.xlsx(pbf_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
write.xlsx(fam_ind_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
quilom_2018$IN_FAMILIA_QUILOMBOLA_FAM <- quilom_2018$IN_FAMILIA_QUILOMBOLA_FAM[quilom_2018$IN_FAMILIA_QUILOMBOLA_FAM==c(1, 2)]<-c("Sim", "Não")

write.xlsx(quilom_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
write.xlsx(mds_fam_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
write.xlsx(ult_atua_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
esta_cadas_2018$CO_EST_CADASTRAL_MEMB <- esta_cadas_2018$CO_EST_CADASTRAL_MEMB [esta_cadas_2018$CO_EST_CADASTRAL_MEMB ==c(3, 4, 5)]<-c("Cadastrado", "Excluído", "Aguardando NIS")

write.xlsx(esta_cadas_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
write.xlsx(sexo_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
write.xlsx(cor_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
write.xlsx(idade_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
write.xlsx(transtorno_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
write.xlsx(ler_escrever_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
instrucao_2018$GRAU_INSTRUCAO <- instrucao_2018$GRAU_INSTRUCAO[instrucao_2018$GRAU_INSTRUCAO==c(0, 1, 2, 3, 4, 5, 6)]<-c("Sem Dados", "Sem Instrução", "Fundamental Incompleto", "Fundamental Completo", "Ensino Médio Incompleto", "Ensino Médio Completo", "Superior Incompleto ou Mais")

write.xlsx(instrucao_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
write.xlsx(curso_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
principal_trabalho_2018$CO_PRINCIPAL_TRAB_MEMB <- principal_trabalho_2018$CO_PRINCIPAL_TRAB_MEMB [principal_trabalho_2018$CO_PRINCIPAL_TRAB_MEMB ==c(1, 2, 3, 4, 5, 6, 7, 8, 10, 11, "Sem Dados")]<-c("Informal, Autônomo", "Trabalhador temporário em área rural", "Empregado sem carteira de trabalho assinada", "Empregado com carteira de trabalho assinada", "Trabalhador doméstico sem carteira de trabalho assinada", "Trabalhador doméstico com carteira de trabalho assinada", "Trabalhador Não-Remunerado" , "Militar ou servidor público", "Estagiário" , "Aprendiz", "Sem Dados")

write.xlsx(principal_trabalho_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
...
write.xlsx(trabalho_12_meses_2018, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2018.xlsx",
