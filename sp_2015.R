...
### Subseccionar Dados de SP de 2015

munic_2015 <- subset(brasil_munic_2015, id %in% c(3550308))
...
library(writexl)
library(xlsx)
write.xlsx(renda_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
write.xlsx(pbf_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
write.xlsx(fam_ind_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
quilom_2015$IN_FAMILIA_QUILOMBOLA_FAM <- quilom_2015$IN_FAMILIA_QUILOMBOLA_FAM[quilom_2015$IN_FAMILIA_QUILOMBOLA_FAM==c(1, 2)]<-c("Sim", "Não")

write.xlsx(quilom_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
write.xlsx(mds_fam_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
write.xlsx(ult_atua_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
esta_cadas_2015$CO_EST_CADASTRAL_MEMB <- esta_cadas_2015$CO_EST_CADASTRAL_MEMB [esta_cadas_2015$CO_EST_CADASTRAL_MEMB ==c(1, 2, 3, 4, 5, 6)]<-c("Em Cadastramento", "Sem Registro Civil", "Cadastrado", "Excluído", "Aguardando NIS" ,"Validando NIS")

write.xlsx(esta_cadas_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
write.xlsx(sexo_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
cor_2015$CO_RACA_COR_PESSOA <- cor_2015$CO_RACA_COR_PESSOA[cor_2015$CO_RACA_COR_PESSOA==c(1, 2, 3, 4, 5, 6)]<-c("Branca", "Preta", "Amarela", "Parda", "Indígena", "Sem Dados")

write.xlsx(cor_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
write.xlsx(idade_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
write.xlsx(transtorno_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
write.xlsx(ler_escrever_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
instrucao_2015$GRAU_INSTRUCAO <- instrucao_2015$GRAU_INSTRUCAO[instrucao_2015$GRAU_INSTRUCAO==c(0, 1, 2, 3, 4, 5, 6)]<-c("Sem Dados", "Sem Instrução", "Fundamental Incompleto", "Fundamental Completo", "Ensino Médio Incompleto", "Ensino Médio Completo", "Superior Incompleto ou Mais")

write.xlsx(instrucao_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
write.xlsx(curso_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
principal_trabalho_2015$CO_PRINCIPAL_TRAB_MEMB <- principal_trabalho_2015$CO_PRINCIPAL_TRAB_MEMB [principal_trabalho_2015$CO_PRINCIPAL_TRAB_MEMB ==c(1, 2, 3, 4, 5, 6, 8, "Sem Dados")]<-c("Informal, Autônomo", "Trabalhador temporário em área rural", "Empregado sem carteira de trabalho assinada", "Empregado com carteira de trabalho assinada", "Trabalhador doméstico sem carteira de trabalho assinada", "Trabalhador doméstico com carteira de trabalho assinada", "Militar ou servidor público", "Sem Dados")

write.xlsx(principal_trabalho_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
...
write.xlsx(trabalho_12_meses_2015, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/sp/2015.xlsx",
