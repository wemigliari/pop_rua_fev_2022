...
test<-subset(test, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 12 a 17 anos" & FX_ETARIA!="de 18 a 21 anos"
...
test2<-subset(test2, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 12 a 17 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos")
...
test3<-subset(test3, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 12 a 17 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos")
...
test4<-subset(test4, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 12 a 17 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos")
...
test5<-subset(test5, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 12 a 17 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos")
...
test6<-subset(test6, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 12 a 17 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos")
...
test7<-subset(test7, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 12 a 17 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos")
...
test8<-subset(test8, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 12 a 17 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos")
...
test9<-subset(test9, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 12 a 17 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos")
...
test10<-subset(test10, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 12 a 17 anos" & FX_ETARIA!="de 18 a 21 anos"
               & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos")
...
serie_historica_idosos_cidades <- rbind(munic_2021_pop_rua,
                                          munic_2020_pop_rua,
                                          munic_2019_pop_rua, 
                                          munic_2018_pop_rua, 
                                          munic_2017_pop_rua, 
...
write_xlsx(serie_historica_idosos_cidades, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/serie_historica_idosos_cidades.xlsx")
