...
test<-subset(test, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 18 a 21 anos"
...
write_xlsx(munic_2021_pop_rua, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/idade_adolescentes_cidades_2021.xlsx")
...
test2<-subset(test2, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos"
              & FX_ETARIA!="de 60 anos acima")
...
write_xlsx(munic_2020_pop_rua, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/idade_adolescentes_cidades_2020.xlsx")
...
test3<-subset(test3, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos"
              & FX_ETARIA!="de 60 anos acima")
...
write_xlsx(munic_2019_pop_rua, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/idade_adolescentes_cidades_2019.xlsx")
...
test4<-subset(test4, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos"
              & FX_ETARIA!="de 60 anos acima")
...
write_xlsx(munic_2018_pop_rua, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/idade_adolescentes_cidades_2018.xlsx")
...
test5<-subset(test5, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos"
              & FX_ETARIA!="de 60 anos acima")
...
write_xlsx(munic_2017_pop_rua, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/idade_adolescentes_cidades_2017.xlsx")
...
test6<-subset(test6, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos"
              & FX_ETARIA!="de 60 anos acima")
...
write_xlsx(munic_2016_pop_rua, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/idade_adolescentes_cidades_2016.xlsx")
...
test7<-subset(test7, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos"
              & FX_ETARIA!="de 60 anos acima")
...
write_xlsx(munic_2015_pop_rua, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/idade_adolescentes_cidades_2015.xlsx")
...
test8<-subset(test8, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos"
              & FX_ETARIA!="de 60 anos acima")
...
write_xlsx(munic_2014_pop_rua, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/idade_adolescentes_cidades_2014.xlsx")
...
test9<-subset(test9, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 18 a 21 anos"
              & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos"
              & FX_ETARIA!="de 60 anos acima")
...
write_xlsx(munic_2013_pop_rua, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/idade_adolescentes_cidades_2013.xlsx")
...
test10<-subset(test10, FX_ETARIA!="até 11 anos" & FX_ETARIA!="de 18 a 21 anos"
               & FX_ETARIA!="de 22 a 29 anos" & FX_ETARIA!="de 30 a 59 anos"
               & FX_ETARIA!="de 60 anos acima")
...
write_xlsx(munic_2012_pop_rua, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/idade_adolescentes_cidades_2012.xlsx")


##########


serie_historica_adolescentes_cidades <- rbind(munic_2021_pop_rua,
                                          munic_2020_pop_rua,
                                          munic_2019_pop_rua, 
                                          munic_2018_pop_rua, 
                                          munic_2017_pop_rua, 
...
write_xlsx(serie_historica_adolescentes_cidades, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/serie_historica_adolescentes_cidades.xlsx")
...
serie_historica_adolescentes_cidades_10 <- rbind(munic_2012_pop_rua_10,
...
write_xlsx(serie_historica_adolescentes_cidades_10, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/serie_historica_adolescentes_10_cidades.xlsx")
