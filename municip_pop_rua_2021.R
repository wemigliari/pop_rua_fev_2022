...
write_xlsx(brasil_munic_2021_pop_rua, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/municipios_pop_rua_2021.xlsx")
...
mytext <- paste(
  "Município: ", brasil_munic_2021_pop_rua$nome, "<br/>",
...
leaflet(shp_joined_2021) %>% 
  ...
  addLegend(pal=mypalette, values=~brasil_munic_2021_pop_rua$freq, opacity=1, title = "Municípios, Totais de Moradores em Situação de Rua, 2020", position = "bottomright" )%>%
