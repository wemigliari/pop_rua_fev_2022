...
instrucao_2012$GRAU_INSTRUCAO <- instrucao_2012$GRAU_INSTRUCAO[instrucao_2012$GRAU_INSTRUCAO==c(0, 1, 2, 3, 4, 5, 6)]<-c("Sem Dados", "Sem Instrução", "Fundamental Incompleto", "Fundamental Completo", "Ensino Médio Incompleto", "Ensino Médio Completo", "Superior Completo")
